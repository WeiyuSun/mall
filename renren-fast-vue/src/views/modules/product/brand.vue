...
<!--        &lt;!&ndash; <el-button v-if="isAuth('product:brand:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>-->
<!--        <el-button v-if="isAuth('product:brand:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button> &ndash;&gt;-->
...
<!--      </el-table-column>-->
<!--      <el-table-column prop="brandId" header-align="center" align="center" label="ID">-->
<!--      </el-table-column>-->
<!--      <el-table-column prop="name" header-align="center" align="center" label="name">-->
<!--      </el-table-column>-->
<!--      <el-table-column prop="logo" header-align="center" align="center" label="Logo" min-width="50%">-->
...
<!--            <img :src="scope.row.logo" height="70%" width="70%">-->

<!--        </template>-->
<!--      </el-table-column>-->
<!--      <el-table-column prop="descript" header-align="center" align="center" label="Description">-->
<!--      </el-table-column>-->
...
<!--        </template>-->
<!--      </el-table-column>-->
<!--      <el-table-column prop="firstLetter" header-align="center" align="center" label="Index">-->
<!--      </el-table-column>-->
<!--      <el-table-column prop="sort" header-align="center" align="center" label="Sort">-->
<!--      </el-table-column>-->
...
<!--    updateBrandStatus({ brandId, showStatus }) {-->
<!--      this.$http({-->
