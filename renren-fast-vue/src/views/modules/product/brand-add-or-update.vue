...
<!--        &lt;!&ndash; <el-input v-model="dataForm.logo" placeholder="Logo address"></el-input> &ndash;&gt;-->
...
<!--        &lt;!&ndash; <el-input v-model="dataForm.showStatus" placeholder="Status"></el-input> &ndash;&gt;-->
